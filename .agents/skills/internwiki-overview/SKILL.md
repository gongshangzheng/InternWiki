...
7. **工作区职责边界**：InternWiki 是**任务管理平台**，不是执行实际研究/开发/写作任务的工作区。当用户说"调研 XX""研究 XX"时，应在 InternWiki 中创建/更新项目和任务来跟踪进度、记录进展，而不是在此工作区中执行实际的调研管线（如 read-article 等在专用工作区 ~/gongshangzheng.github.io 中执行）。实际执行和产出在其他专用工作区完成，InternWiki 只负责项目管理、进度跟踪和知识沉淀。
7. **工作区职责边界**：InternWiki 是**任务管理平台**，不是执行实际研究/开发/写作任务的工作区。当用户说"调研 XX""研究 XX"时，应在 InternWiki 中创建/更新项目和任务来跟踪进度、记录进展，而不是在此工作区中执行实际的调研管线（如 read-article 等在专用工作区 ~/gongshangzheng.github.io 中执行）。实际执行和产出在其他专用工作区完成，InternWiki 只负责项目管理、进度跟踪和知识沉淀。
